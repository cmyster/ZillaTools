...
def get_average_time(time_to_close, closed_bugs, rhosp):
    ...
    message = 'On average it took {} years, {} months and {} days to close a bug in rhosp {}.'.format(
        years, months, days, rhosp)
    return message
